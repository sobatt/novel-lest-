			...
			<div id="Extension">
				...
				<div id="Recommend">
					...
					<div id="Recommend-main">
						...
						<router-link to='CardMaker'><div class="Recommend-main-item" ><img :src="recommend1.picture"/></div></router-link>
						<router-link to='TheTaoistCareer'><div class="Recommend-main-item"><img :src="recommend2.picture"/></div></router-link>	
						 -->
...
//			this.index1 = this.chaptercontent;
	...
	//			this.list = (res.body.ResultDate.bookInfo);
			...
			chapters2:function(){
				this.$http.post('https://www.meejee.net/chapter/',{book_id:5,chapter_id:2},
				{emulateJSON:true})
				.then(res => {
				this.is=false;
				this.is1=true;
	...
	//			this.list = (res.body.ResultDate.bookInfo);
			...
			chapters3:function(){
				this.$http.post('https://www.meejee.net/chapter/',{book_id:5,chapter_id:3},
				{emulateJSON:true})
				.then(res => {
				this.is=false;
				this.is1=false;
	...
	//			this.list = (res.body.ResultDate.bookInfo);
			...
			chapters4:function(){
				this.$http.post('https://www.meejee.net/chapter/',{book_id:5,chapter_id:4},
				{emulateJSON:true})
				.then(res => {
				this.is=false;
				this.is1=false;
	...
	//			this.list = (res.body.ResultDate.bookInfo);
			...
			chapters5:function(){
				this.$http.post('https://www.meejee.net/chapter/',{book_id:5,chapter_id:5},
				{emulateJSON:true})
				.then(res => {
				this.is=false;
				this.is1=false;
	...
	//			this.list = (res.body.ResultDate.bookInfo);
			...
			next:function(){
				...
				this.$http.post('https://www.meejee.net/chapter/',{book_id:5,chapter_id:this.chapter_id},
				{emulateJSON:true}
			).then(res => {
				this.chapter = (res.body.ResultDate.chapterInfo);
