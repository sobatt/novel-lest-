...
//			this.ro();
	...
	//			this.list = (res.body.ResultDate.bookInfo);
			...
			chapters2:function(){
				this.$http.post('https://www.meejee.net/chapter/',{book_id:6,chapter_id:2},
				{emulateJSON:true})
				.then(res => {
	//			this.list = (res.body.ResultDate.bookInfo);
				this.is=false;
...
//					console.log(this.recommend);
			...
			chapters3:function(){
				this.$http.post('https://www.meejee.net/chapter/',{book_id:6,chapter_id:3},
				{emulateJSON:true})
				.then(res => {
	//			this.list = (res.body.ResultDate.bookInfo);
				this.is=false;
			...
			chapters4:function(){
				this.$http.post('https://www.meejee.net/chapter/',{book_id:6,chapter_id:4},
				{emulateJSON:true})
				.then(res => {
				this.is=false;
				this.is1=false;
	...
	//			this.list = (res.body.ResultDate.bookInfo);
			...
			chapters5:function(){
				this.$http.post('https://www.meejee.net/chapter/',{book_id:6,chapter_id:5},
				{emulateJSON:true})
				.then(res => {
				this.is=false;
				this.is1=false;
	...
	//			this.list = (res.body.ResultDate.bookInfo);
			...
			chapters6:function(){
				this.$http.post('https://www.meejee.net/chapter/',{book_id:6,chapter_id:6},
				{emulateJSON:true})
				.then(res => {
				this.is=false;
				this.is1=false;
...
//				this.nc=this.nc+1;
				this.$http.post('https://www.meejee.net/chapter/',{book_id:6,chapter_id:this.chapter_id},
				{emulateJSON:true}
			).then(res => {
				this.chapter = (res.body.ResultDate.chapterInfo);
