...
//					console.log(this.recommend);
			...
			chapters3:function(){
				this.$http.post('http://47.94.240.34/chapter/',{book_id:2,chapter_id:3},
				{emulateJSON:true})
				.then(res => {
	//			this.list = (res.body.ResultDate.bookInfo);
				this.chapter = (res.body.ResultDate.chapterInfo);
			...
			chapters4:function(){
				this.$http.post('http://47.94.240.34/chapter/',{book_id:2,chapter_id:4},
				{emulateJSON:true})
				.then(res => {
	//			this.list = (res.body.ResultDate.bookInfo);
				this.chapter = (res.body.ResultDate.chapterInfo);
	...
	//			this.list = (res.body.ResultDate.bookInfo);
			...
			//分页
			next:function(){
				this.$http.post('http://47.94.240.34/chapter/',{book_id:2,chapter_id:this.chapter_id},
				{emulateJSON:true}
				).then(res => {
//				this.chapter_id =(res.body.ResultDate.chapterInfo.chapter_id);
...
//					alert('ok');
					console.log(mail)
					this.$http.post('http://47.94.240.34/subscibe/',{book_id:this.detailId,chapter_id:this.chapter_id,email:mail,type:'facebook'},{emulateJSON:true}
				    ).then(res => {
					console.log(res);
					},err => {
				//alert('wrong');
