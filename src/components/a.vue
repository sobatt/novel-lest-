	...
	<div id="wrap">
		...
		<div id="main-wrap-big">
			...
			<div id="Directory-options">
				...
				<div id="Directory-options-item" @click="chapters6" v-bind:class="{'ces':is5,'cess':iss}">Chapter6</div>
			...
			<div id="Extension">
				...
				<div id="Recommend">
					...
					<div id="Recommend-main">
						<!-- <div id="Recommend-main-wrap"> -->
							<!-- <router-link to='MyNightclubLandlady'><div class="Recommend-main-item"><img :src="recommend.picture"/></div></router-link>
							<router-link to='TheTaoistCareer'><div class="Recommend-main-item" ><img :src="recommend1.picture"/></div></router-link>
							<router-link to='CardMaker'><div class="Recommend-main-item"><img :src="recommend2.picture"/></div></router-link>	
							<router-link to='PsychicTattoo'><div class="Recommend-main-item"><img :src="recommend3.picture"/></div></router-link>	
							<router-link to='ReturnoftheSoldierKing'><div class="Recommend-main-item"><img :src="recommend4.picture"/></div></router-link>
							<router-link to='/'><div class="Recommend-main-item"><img :src="recommend5.picture"/></div></router-link>	
							<router-link to="TheTaleoftheGhostEyes"><div class="Recommend-main-item"><img :src="recommend6.picture"/></div></router-link>	 -->
		...
		<div id="window-wrap" v-show="isshow">
			<div id="Catalog-window">
				...
				<div id="catalog-main">
					<ul>
						<li v-for="li in ulList" :key="li" @click="changeColor(2, li)" :class='{active:index==li}'>Chapter 1: Snow Eagle Territory</li>
					</ul>
				</div>
			</div>
		</div>
	...
	export default {
		data() {
			return {
				...
				bookid:"",
				faceid: "",
				ulList1: ['chapter1','chapter2','chapter3','chapter4','chapter5'],
				is:false,is1:false,is2:false,is3:false,is4:false,is5:false,iss:false,
				index1: 1,
				ulList: [1,2,3,4,5,6,7,8],
				index: 1,
				page:"",
				...
				"the chapter of the 4",
				"the chapter of the 5",
				"the chapter of the 6",
				"the chapter of the 7"
				],
				chapter2:[],
				chapterindex: 1,//章节数
				chaptercontent: "",//显示内容
		...
		created() {
            ...
            this.suggestionBooks=res.body.ResultDate.suggestionBooks;
...
//			this.index1 = this.chaptercontent;	
		...
		methods: {
            ...
            novel:function(){
                this.$http.post('https://www.meejee.net/chapter/',{book_id:this.detailId,chapter_id:1},
                {emulateJSON:true})
                .then(res=> {
                    this.detailId =(res.body.ResultDate.suggestionBooks.id);
                    console.log(this.detailId)
                })
            },
			//章节
	...
	//			this.list = (res.body.ResultDate.bookInfo);
			...
			chapters2:function(){
				this.$http.post('https://www.meejee.net/chapter/',{book_id:1,chapter_id:2},
				{emulateJSON:true})
				.then(res => {
	//			this.list = (res.body.ResultDate.bookInfo);
				this.is=false;
				...
				this.chapter_id = parseInt(res.body.ResultDate.chapterInfo.chapter_id);
				this.$router.push({query: {detailId: this.detailId,chapter_id:this.chapter_id}}) // 跳转
//				this.content = this.$route.chapter_id.replace(/\n/g, "<br/>");
//					console.log(this.recommend);
			...
			chapters3:function(){
				this.$http.post('https://www.meejee.net/chapter/',{book_id:1,chapter_id:3},
				{emulateJSON:true})
				.then(res => {
	//			this.list = (res.body.ResultDate.bookInfo);
				this.is=false;
			...
			chapters4:function(){
				this.$http.post('https://www.meejee.net/chapter/',{book_id:1,chapter_id:4},
				{emulateJSON:true})
				.then(res => {
				this.is=false;
				this.is1=false;
	...
	//			this.list = (res.body.ResultDate.bookInfo);
			...
			chapters5:function(){
				this.$http.post('https://www.meejee.net/chapter/',{book_id:1,chapter_id:5},
				{emulateJSON:true})
				.then(res => {
				this.is=false;
				this.is1=false;
	...
	//			this.list = (res.body.ResultDate.bookInfo);
			...
			chapters6:function(){
				this.$http.post('https://www.meejee.net/chapter/',{book_id:1,chapter_id:6},
				{emulateJSON:true})
				.then(res => {
				this.is=false;
				this.is1=false;
...
//				this.detailId = this.bookid[0];
			...
			//章节选项样式切换
			changeColor: function (s, a,index1) {
				if(s == 1) {
//					this.chapterid = this.index1;
...
/*		margin-left: 10%;*/
	...
	#footer {
		width: 100%;
		height: 1.763888rem;
		background: url(../../static/images/Facebookxuanfu.png)no-repeat;
