<template>
	<div id="wrap">
		...
		<div id="main-wrap-big">
			<!--banner-->
			<div id="banner">
				<img src="../../static/images/zhutu.png" />
			</div>
			<!--author-->
			<div id="author">
				<span>Author:  I Eat Tomatoes</span>
			</div>
			<!--introduce-->
			<div id="introduce">
				<p>asd</p>
			...
			<div id="Directory-options">
				<div id="Directory-options-item" v-for="item in ulList1" :key="item" @click="changeColor(1, item)" :class='{active:index1==item}'>Chapter1</div>
				<!--<div id="Directory-options-item">Chapter2</div>
				<div id="Directory-options-item">Chapter3</div>
				<div id="Directory-options-item">Chapter4</div>
				<div id="Directory-options-item">Chapter5</div>
			...
			<div id="main-wrap">
				<div id="main-subject">
					<h3>Chapter 1: Snow Eagle Territory</h3></div>
				<div id="main-text">
				...
				<div id="Chapter-options">
					<div id="Chapter-options-item"><span>Previous</span></div>
					<div id="Chapter-options-item" @click="pages"><span>Next</span></div>
				</div>
			</div>
			<!--Extension-->
			<div id="Extension">
...
<script>
	...
	export default {
		...
		methods: {
			...
			pages:function　(){
//				this.getBookId();
				this.$http.post('http://47.94.240.34/chapter/',{book_id:"",chapter_id:""},{emulateJSON:true}
				).then(res => {
			//this.list = (res.data.data);
				console.log(res);
					},err => {
...
//					this.$http({
//					method:'post',
//					url:'http://47.94.240.34:5432/subscibe/',
//					params:{
//					book_id: 1,
//					chapter_id: 1
//						}
