			...
			<div id="Extension">
				...
				<div id="Recommend">
					...
					<div id="Recommend-main">
						...
						<div class="Recommend-main-item" @click="recom"><img :src="recommend.picture"/></div>
						<div class="Recommend-main-item" @click="recom1"><img :src="recommend1.picture"/></div>
						<div class="Recommend-main-item" @click="recom2"><img :src="recommend2.picture"/></div>						
					</div>
				</div>
			</div>
		</div>
...
//				.then(res => {
//				this.list = (res.body.ResultDate.bookInfo);
//				this.chapter2 = (res.body.ResultDate.chapterInfo);
...
//				});
	...
	//			this.list = (res.body.ResultDate.bookInfo);
			...
			chapters2:function(){
				this.$http.post('http://47.94.240.34/chapter/',{book_id:1,chapter_id:2},
				{emulateJSON:true})
				.then(res => {
	//			this.list = (res.body.ResultDate.bookInfo);
				this.chapter = (res.body.ResultDate.chapterInfo);
//					console.log(this.recommend);
			...
			chapters3:function(){
				this.$http.post('http://47.94.240.34/chapter/',{book_id:1,chapter_id:3},
				{emulateJSON:true})
				.then(res => {
	//			this.list = (res.body.ResultDate.bookInfo);
				this.chapter = (res.body.ResultDate.chapterInfo);
			...
			chapters4:function(){
				this.$http.post('http://47.94.240.34/chapter/',{book_id:1,chapter_id:4},
				{emulateJSON:true})
				.then(res => {
	//			this.list = (res.body.ResultDate.bookInfo);
				this.chapter = (res.body.ResultDate.chapterInfo);
			...
			chapters5:function(){
				this.$http.post('http://47.94.240.34/chapter/',{book_id:1,chapter_id:5},
				{emulateJSON:true})
				.then(res => {
	//			this.list = (res.body.ResultDate.bookInfo);
				this.chapter = (res.body.ResultDate.chapterInfo);
